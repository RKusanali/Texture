...
GLfloat vertices[] ={ 
	...
	-0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 0.0f,      0.0f, 0.5f, -0.8f, // Bas
...
int main(){
	...
	// Texture
	Texture Tex((parentDir + "R.png").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	Tex.texUnit(shaderProgram, "tex0", 0);
	Texture Spec((parentDir + "/Use/textures/planksSpec.png").c_str(), GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE);
	Spec.texUnit(shaderProgram, "tex1", 1);
